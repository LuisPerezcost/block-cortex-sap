...
- dashboard: income_statement_template
  ...
  - name: Select Fiscal Timeframe
    ...
    type: field_filter
    # if using demo data default is 2025.Q4 else find current calendar quarter
    default_value: "{% if _user_attributes['sap_use_demo_data']=='Yes'%}{% assign qtr = '2025.Q4'%}{%else%}{% assign q = 'now' | date: '%m' | times: 1.0 | divided_by: 3 | ceil %}{% assign qtr = 'now' | date: '%Y' | append: '.Q' | append: q %}{%endif%}{{qtr}}"
